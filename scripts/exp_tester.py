...
def main():
    ...
    parser.add_argument(
        "json_config",
        type=str,
        help="The experiment testing configuration file in json",
    )
    ...
    with open(res_csv, "w") as f:
        ...
        for solver in test_solvers.keys():
            ...
            print(
                f"{solver} test results: solved {resTuple[0]} instances with par2 {resTuple[1]} and par10 {resTuple[2]:.2f}"
            )
