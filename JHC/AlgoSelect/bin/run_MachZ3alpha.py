...
def run_stage1(config):
    ...
    selected_strats = stage1_synthesize(config, log, log_folder)
    ...
    return {"log_folder": log_folder, "best_strategies": bst_strats}
...
def prepare_stage2_config(machsmt_config_path, stage1_results):
    ...
    config["paths"]["default_strat"] = os.path.join(stage1_folder, "synthesized_.txt")
...
def run_stage2(stage1_results, machsmt_config_path):
    ...
    stage2_script = "JHC/AlgoSelect/run_MachSMT.py"
